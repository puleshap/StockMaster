 ...
 */
public class UpdateStockPrice extends javax.swing.JDialog {

    /**
     * Creates new form CategoryDialog
     */
    public UpdateStockPrice(java.awt.Frame parent, boolean modal, String Stock, String Product, String status) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Selling Price");
        ...
        jLabel10.setText("New Selling Price :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (price.isEmpty()) {
            ...
            if (price.matches("\\d+")) {
                Sql.iud("UPDATE `stock` SET `selling_price` = '" + price + "',"
                        + "status_id = '" + cat + "' "
                        + "WHERE stock_id ='" + jLabel7.getText() + "' ");
