 ...
 */
public class ShowPassword extends javax.swing.JDialog {

    /**
     * Creates new form PasswordSpecialAccess
     */
    public ShowPassword(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShowPassword dialog = new ShowPassword(new javax.swing.JFrame(), true);
